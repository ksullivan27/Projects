...
class Inventory(base.Action):
    ...
    def __init__(
        ...
        super().__init__(game)
        self.character = self.parser.get_character(command, hint="person whose items are being enumerated")
...
class Unlock_Door(base.Action):
    ...
    def __init__(self, game, command):
        ...
        self.character = self.parser.get_character(command, key="person unlocking thing")
